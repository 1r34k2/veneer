...
const ChatInput = function({name, chatId}){
  ...
  return <div className="border-t border-gray-2000 p-4 ">
    <div className="relative flex-1 overflow-hidden rounded-lg shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-indigo-600">
      ...
      className='bg-white block w-full resize-none border-0 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:py-1.5 sm:leading-6'
      />
      <div onClick={()=>{
          textareaRef.current.focus()
      }} className='py-2 bg-white' aria-hidden='true'>
        <div className='py-px'>
            <div className="h-9" />     
        </div>
        </div>
